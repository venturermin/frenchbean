...
/**
 * Created by bum on 12/15/17.
 */

public class ViewPagerIndicatorActivity extends LinearLayout {
    ...
    public ViewPagerIndicatorActivity(Context context) {
        super(context);

        mContext = context;
    }

    public ViewPagerIndicatorActivity(Context context, AttributeSet attrs) {
        super(context, attrs);
